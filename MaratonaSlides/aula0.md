...
Competição de quem resolve mais problemas de programação em menos tempos.
...
# Requisitos pro Certificado

<v-clicks>

- 75% de Participação nas aulas

- 50% de resolução das atividades
...
- Se acostumem com a sensação de não saber algo, pratiquem até aprender.
...
# Como usar LLMs pra estudar

<v-clicks>

- Nunca copie e cole código
...
- Me dê 3 dicas para entender a ideia do problema a seguir, não gere nenhum código. Problema :

- Gere o pseudocódigo para a solução do seguinte problema:

- Explique a complexidade do seguinte código que eu implementei:

</v-clicks>

---

# Pra quem estiver com dificuldade

<v-clicks>

- Tranformar ideias em códigos pode ser dificil no começo, mas não desistam, no futuro vocês vão se agradecer por terem continuado.

- Se você estiver com dificuldades para resolver questões, resolva questões.
...
- Site com ótimas questões e tem um roadmap 
[Link](https://marisaoj.com/level/0)

---

# Links que vocês devem entrar
